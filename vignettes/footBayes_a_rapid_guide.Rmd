...
```{r BTD_data, echo = TRUE, eval = TRUE}
library(dplyr)
library(footBayes) 
...
\begin{align}
\psi_{t,\tau} \sim \mathrm{N}(\mu_{\psi_{t,\tau}}, \sigma_\psi)        
\end{align}
...
```{r BTD_model_1_dyn, message = FALSE, results='hide', echo = TRUE, eval = TRUE}
...
```{r BTD_model_1_dyn_print, message = FALSE, echo = TRUE, eval = TRUE}
...
```{r BTD_model_1_stat, message = FALSE, results='hide', echo = TRUE, eval = TRUE}
...
```{r BTD_model_1_stat_print, message = FALSE, echo = TRUE, eval = TRUE}
...
```{r BTD_model_2, message = FALSE, results='hide', echo = TRUE, eval = TRUE}
# Dynamic Ranking Example with Median Rank Measure
...
```{r BTD_model_2_dyn_print, message = FALSE, echo = TRUE, eval = TRUE}
...
```{r BTD_model_2_stat, message = FALSE, results='hide', echo = TRUE, eval = TRUE}
...
```{r BTD_model_2_stat_print, message = FALSE, echo = TRUE, eval = TRUE}
...
```{r plot_btdPosterior_dyn, echo = TRUE, eval = TRUE, fig.show="hold"}
...
```{r plot_btdPosterior_stat, echo = TRUE, eval = TRUE, fig.show="hold"}
...
```{r plot_btdPosterior_teams_dyn, echo = TRUE, eval = TRUE, fig.show="hold"}
...
```{r plot_btdPosterior_teams_stat, echo = TRUE, eval = TRUE, fig.show="hold"}
...
```{r plot_btdPosterior_teams_dyn_dens, echo = TRUE, eval = TRUE, fig.show="hold"}
...
```{r plot_btdPosterior_teams_stat_dens, echo = TRUE, eval = TRUE, fig.show="hold"}
...
```{r plot_logStrength_teams_dyn, echo = TRUE, eval = TRUE, fig.show="hold"}
...
```{r static_fit, message = FALSE, results='hide', echo = TRUE, eval = TRUE}
...
```{r static_fit_print, message = FALSE, echo = TRUE, eval = TRUE}

## Print of model summary for parameters:

print(fit1_stan, 
      pars = c("home", "rho", "sigma_att",
               "sigma_def", "att", "def"),
      teams = c("AC Milan", "AS Roma"))
```
...
```{r static_fit_corr, echo =TRUE, eval = TRUE}
...
```{r stan_extract, echo = TRUE, eval = TRUE}
...
```{r static_fit2, echo = TRUE, eval = TRUE}
### Fit MLE models
## no dynamics, no predictions
## Wald intervals
...
```{r static_fit_priors, message = FALSE, results='hide', echo =TRUE, eval = TRUE}
### Fit Stan models
## changing priors
...
```{r comparing_priors, eval = TRUE}
## comparing posteriors

posterior1_t <- as.matrix(fit1_stan_t$fit)
...
```{r dynamic_fit,message = FALSE, results='hide', echo =TRUE, eval = TRUE}
### Fit Stan models
...
```{r dynamic_fit_print, message = FALSE, echo = TRUE, eval = TRUE}
...
```{r weekly_fit, message = FALSE, results='hide', echo = TRUE, eval = TRUE}
### Fit Stan models
...
```{r weekly_fit_print, message = FALSE, echo = TRUE, eval = TRUE}
...
```{r weekly_fit_t, message = FALSE, results='hide', echo = TRUE, eval = TRUE}
### Fit Stan models
## weekly dynamics, no predictions
## 4 chains, 'n_iter' iterations each
...
```{r weekly_fit_t_print, message = FALSE, echo = TRUE, eval = TRUE}
...
```{r btd_foot_and_stan_foot, message = FALSE, results='hide', echo = TRUE, eval = TRUE}
...
# Dynamic Bivariate Poisson Model 
 ...
 fit_stan_rank <- stan_foot(data = italy_2020_2021_fit,
                           model="biv_pois",
                           ranking = fit_btd_dyn,
                           predict = 180,
                           prior_par = list(
...
```{r btd_foot_and_stan_foot_print, message = FALSE, echo = TRUE, eval = TRUE}
...
```{r abilities, echo = TRUE, eval = TRUE, fig.show="hold"}
...
```{r abilities_dyn, echo = TRUE, eval = TRUE, fig.show="hold"}
## Plotting abilities: credible and confidence 95% intervals
...
```{r pp_foot, echo = TRUE, eval = TRUE}
## PP checks: aggregated goal's differences and ordered goal differences

pp_foot(object = fit1_stan, data = italy_2000,
        type = "aggregated")
...
```{r pp_checks, echo = TRUE, eval = TRUE}
...
```{r weekly_predict,message = FALSE, results='hide', echo=TRUE, eval = TRUE}
### Fit Stan models
...
```{r foot_prob_weekly_predict, echo = TRUE, eval = TRUE, fig.show="hold"}
...
```{r foot_roundrobin, echo=TRUE, eval = TRUE}
...
```{r rank_pred1, echo=TRUE, eval = TRUE}
## Rank league reconstruction
...
```{r rank_pred2, echo=TRUE, eval = TRUE}
...
```{r compare_foot, message = FALSE, results='hide', echo = TRUE, eval = TRUE}
...
fit_comp_1 <- stan_foot(data = italy_2020_2021_fit,
                       model="biv_pois",
                       home_effect = TRUE,
                       predict = 190,
                       dynamic_type = "season",
...
fit_comp_2 <- stan_foot(data = italy_2020_2021_fit,
                       model="double_pois",
                       home_effect = TRUE,
                       predict = 190,
                       dynamic_type = "season",
...
```{r compare_foot_print, message = FALSE, echo = TRUE, eval = TRUE}

compare_results_models <- compare_foot(
  source = list(biv_pois = fit_comp_1,
...
```{r loo, echo = TRUE, eval = TRUE}
### Model comparisons
## LOOIC, loo function

# extract pointwise log-likelihood

log_lik_1 <- extract_log_lik(fit1_stan$fit)
log_lik_1_t <- extract_log_lik(fit1_stan_t$fit)
log_lik_2 <- extract_log_lik(fit2_stan$fit)
log_lik_3 <- extract_log_lik(fit3_stan$fit)
log_lik_3_t <- extract_log_lik(fit3_stan_t$fit)
