...
```{r footBayes_inst_cran, echo =TRUE, eval = FALSE}
...
```{r BTD_model_vi, message = FALSE, results='hide', echo = TRUE, eval = TRUE}
...
```{r stan_foot_model_pth, message = FALSE, results='hide', echo = TRUE, eval = TRUE}
