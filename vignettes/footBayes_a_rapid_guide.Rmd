...
```{r BTD_model_1_dyn, message = FALSE, results='hide', echo = TRUE, eval = NOT_CRAN}
...
```{r BTD_model_1_dyn_print, message = FALSE, echo = TRUE, eval = NOT_CRAN}
...
```{r BTD_model_1_stat, message = FALSE, results='hide', echo = TRUE, eval = NOT_CRAN}
...
```{r BTD_model_1_stat_print, message = FALSE, echo = TRUE, eval = NOT_CRAN}
...
```{r BTD_model_2_dyn_print, message = FALSE, echo = TRUE, eval = NOT_CRAN}
...
```{r BTD_model_2_stat, message = FALSE, results='hide', echo = TRUE, eval = NOT_CRAN}
...
```{r BTD_model_2_stat_print, message = FALSE, echo = TRUE, eval = NOT_CRAN}
...
```{r static_fit, message = FALSE, results='hide', echo = TRUE, eval = NOT_CRAN}
...
```{r static_fit_print, message = FALSE, echo = TRUE, eval = NOT_CRAN}
...
```{r dynamic_fit_print, message = FALSE, echo = TRUE, eval = NOT_CRAN}
...
```{r weekly_fit_print, message = FALSE, echo = TRUE, eval = NOT_CRAN}
...
```{r weekly_fit_t_print, message = FALSE, echo = TRUE, eval = NOT_CRAN}
...
```{r btd_foot_and_stan_foot, message = FALSE, results='hide', echo = TRUE, eval = NOT_CRAN}
...
```{r btd_foot_and_stan_foot_print, message = FALSE, echo = TRUE, eval = NOT_CRAN}
...
```{r foot_prob_weekly_predict, echo = TRUE, eval = NOT_CRAN, fig.show="hold"}
...
```{r compare_foot, message = FALSE, results='hide', echo = TRUE, eval = NOT_CRAN}
...
```{r compare_foot_print, message = FALSE, echo = TRUE, eval = NOT_CRAN}
