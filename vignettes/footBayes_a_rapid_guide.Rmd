...
```{r plot_btdPosterior, echo = TRUE, eval = NOT_CRAN, fig.show="hold"}

# Dynamic Ranking

plot_btdPosterior(fit_result_dyn)

plot_btdPosterior(fit_result_dyn, teams = c("AC Milan", "AS Roma", "Juventus", "Inter"), ncol = 2)
...
plot_btdPosterior(fit_result_stat, teams = c("AC Milan", "AS Roma", "Juventus", "Inter"), ncol = 2)
