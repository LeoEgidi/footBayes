...
#> 1 logStrength[1, AC Milan]  2.13   2.12  0.916 0.915  0.642 3.66   1.01    316.      745.
#> 2 logStrength[2, AC Milan]  1.29   1.33  1.10  1.07  -0.584 3.05   1.02    148.      173.
#> 3 logStrength[3, AC Milan]  2.28   2.32  1.31  1.33   0.081 4.34   1.02    120.      133.
#> 4 logStrength[4, AC Milan]  2.77   2.76  1.50  1.50   0.246 5.23   1.02    116.      117.
#> 5 logStrength[1, AS Roma]   1.44   1.47  0.862 0.87   0.01  2.85   1.00    278.      682.
#> 6 logStrength[2, AS Roma]  -0.116 -0.076 1.06  1.07  -1.95  1.56   1.02    144.      148.
#> 7 logStrength[3, AS Roma]   0.779  0.805 1.27  1.30  -1.34  2.77   1.03    108.      108.
#> 8 logStrength[4, AS Roma]   0.96   0.974 1.46  1.41  -1.52  3.30   1.03     93.3     109.
#> 9 logTie                   -0.007 -0.007 0.086 0.081 -0.147 0.134  1      1746.     1526.
```
...
#> 11       1           Inter        2.3683
#> 7        1        AC Milan        1.9562
#> 13       1      SSC Napoli        1.6682
#> 6        1        Juventus        1.6284
#> 20       1        Atalanta        1.2898
#> 19       1      Lazio Roma        1.0702
#> 15       1         AS Roma        0.7336
#> 5        1 Sassuolo Calcio        0.4305
#> 1        1  ACF Fiorentina        0.2399
#> 8        1       Torino FC        0.0668
#> 
#> Posterior summaries for model parameters:
#> # A tibble: 3 × 10
#>   variable                mean median    sd   mad     q5   q95  rhat ess_bulk ess_tail
#>   <chr>                  <dbl>  <dbl> <dbl> <dbl>  <dbl> <dbl> <dbl>    <dbl>    <dbl>
#> 1 logStrength[AC Milan]  2.02   2.02  0.722 0.756  0.845 3.14   1.00     152.     242.
#> 2 logStrength[AS Roma]   0.846  0.848 0.707 0.711 -0.331 1.99   1.00     145.     205.
#> 3 logTie                -0.12  -0.118 0.084 0.087 -0.255 0.019  1        987.    1164.
```
...
#>   variable  mean median    sd   mad     q5   q95  rhat ess_bulk ess_tail
#>   <chr>    <dbl>  <dbl> <dbl> <dbl>  <dbl> <dbl> <dbl>    <dbl>    <dbl>
#> 1 logTie   0.022  0.025 0.088 0.087 -0.123 0.165  1.00    1713.    1416.
#> 2 home     0.231  0.23  0.106 0.106  0.063 0.401  1       2098.    1073.
```
...
#> 11       1           Inter          4.01
#> 7        1        AC Milan          3.37
#> 13       1      SSC Napoli          3.08
#> 6        1        Juventus          2.99
#> 20       1        Atalanta          2.65
#> 19       1      Lazio Roma          2.46
#> 15       1         AS Roma          2.31
#> 5        1 Sassuolo Calcio          1.76
#> 1        1  ACF Fiorentina          1.64
#> 2        1   Hellas Verona          1.53
#> 
#> Posterior summaries for model parameters:
#> # A tibble: 2 × 10
#>   variable   mean median    sd   mad     q5   q95  rhat ess_bulk ess_tail
#>   <chr>     <dbl>  <dbl> <dbl> <dbl>  <dbl> <dbl> <dbl>    <dbl>    <dbl>
#> 1 logTie   -0.118 -0.119 0.092 0.095 -0.271 0.033  1.01     513.     527.
#> 2 home      0.216  0.217 0.098 0.101  0.052 0.37   1.00     458.     583.
```
...
#>   variable        mean median    sd   mad     q5    q95  rhat ess_bulk ess_tail
#>   <chr>          <dbl>  <dbl> <dbl> <dbl>  <dbl>  <dbl> <dbl>    <dbl>    <dbl>
#> 1 home           0.286  0.288 0.066 0.064  0.173  0.386 0.997    1181.     721.
#> 2 rho           -1.77  -1.75  0.316 0.298 -2.32  -1.31  1.00     1110.     541.
#> 3 sigma_att      0.207  0.202 0.071 0.063  0.098  0.331 1.01      192.     120.
#> 4 sigma_def      0.225  0.218 0.07  0.066  0.126  0.347 1.01      331.     332.
#> 5 att[AS Roma]   0.258  0.253 0.137 0.133  0.035  0.486 1.01      516.     579.
#> 6 att[AC Milan]  0.123  0.12  0.121 0.13  -0.068  0.318 0.999     813.     705.
#> 7 def[AS Roma]  -0.208 -0.197 0.142 0.139 -0.465  0.008 1.01     1000.     403.
#> 8 def[AC Milan]  0.003  0.006 0.131 0.124 -0.217  0.212 1.01     1634.     699.
```
...
#>   variable    mean median    sd   mad     q5    q95  rhat ess_bulk ess_tail
#>   <chr>      <dbl>  <dbl> <dbl> <dbl>  <dbl>  <dbl> <dbl>    <dbl>    <dbl>
#> 1 home       0.275  0.277 0.068 0.07   0.158  0.38   1.02   285.      254. 
#> 2 rho       -1.76  -1.70  0.349 0.343 -2.40  -1.30   1.02   377.      197. 
#> 3 sigma_att  0.047  0.045 0.012 0.015  0.031  0.066  1.88     2.99     60.0
#> 4 sigma_def  0.055  0.054 0.014 0.017  0.035  0.082  1.70     3.28     12.4
```
...
#>   variable   mean median    sd   mad    q5   q95  rhat ess_bulk ess_tail
#>   <chr>     <dbl>  <dbl> <dbl> <dbl> <dbl> <dbl> <dbl>    <dbl>    <dbl>
#> 1 home      0.398  0.399 0.047 0.05  0.322 0.48   1.03   100.      216. 
#> 2 sigma_att 0.052  0.051 0.01  0.01  0.037 0.07   1.41     4.46     53.0
#> 3 sigma_def 0.065  0.061 0.021 0.021 0.035 0.106  1.76     3.14     13.5
```
...
#>   variable   mean median    sd   mad    q5   q95  rhat ess_bulk ess_tail
#>   <chr>     <dbl>  <dbl> <dbl> <dbl> <dbl> <dbl> <dbl>    <dbl>    <dbl>
#> 1 home      0.399  0.399 0.047 0.047 0.324 0.477  1.03    85.0     296. 
#> 2 sigma_att 0.035  0.032 0.014 0.013 0.019 0.062  1.75     3.13     11.7
#> 3 sigma_def 0.059  0.058 0.011 0.011 0.043 0.079  1.34     4.99     34.3
```
...
#>   variable    mean median    sd   mad     q5    q95  rhat ess_bulk ess_tail
#>   <chr>      <dbl>  <dbl> <dbl> <dbl>  <dbl>  <dbl> <dbl>    <dbl>    <dbl>
#> 1 home       0.159  0.16  0.069 0.067  0.043  0.267  1.00  1423.     1155. 
#> 2 rho       -1.10  -1.09  0.166 0.162 -1.39  -0.852  1.00   985.     1283. 
#> 3 sigma_att  0.036  0.035 0.027 0.029  0.001  0.085  1.28     5.36     11.8
#> 4 sigma_def  0.038  0.036 0.023 0.024  0.005  0.078  1.14    10.7      13.0
```
...
#> 1 Reggina Calcio  AC Milan  0.347  0.252  0.401 1-1 (0.116)
#> 
#> $prob_plot
```
...
#> 1   Hellas Verona     Bologna FC     0.392        -
#> 2           Inter     Bologna FC     0.428        -
#> 3  Udinese Calcio     SSC Napoli     0.495        -
#> 4  ACF Fiorentina     SSC Napoli     0.510        -
#> 5        US Lecce     Lazio Roma     0.245        -
#> 6           Inter     Lazio Roma     0.285        -
#> 7  Brescia Calcio        AS Bari     0.698        -
#> 8  Reggina Calcio        AS Bari     0.632        -
#> 9  Udinese Calcio Vicenza Calcio     0.375        -
#> 10 Brescia Calcio Vicenza Calcio     0.542        -
#> 11        AS Roma       Parma AC     0.362        -
#> 12       US Lecce       Parma AC     0.208        -
#> 13        AS Roma       AC Milan     0.470        -
#> 14 Reggina Calcio       AC Milan     0.338        -
#> 15  Hellas Verona     AC Perugia     0.448        -
#> 16       Juventus     AC Perugia     0.662        -
#> 17 ACF Fiorentina       Atalanta     0.462        -
#> 18       Juventus       Atalanta     0.550        -
#> 19     SSC Napoli        AS Roma     0.275        -
#> 20        AS Bari        AS Roma     0.225        -
#> 21     Lazio Roma Udinese Calcio     0.682        -
#> 22       Atalanta Udinese Calcio     0.530        -
#> 23     Bologna FC       US Lecce     0.512        -
#> 24 Vicenza Calcio       US Lecce     0.530        -
#> 25       AC Milan Brescia Calcio     0.455        -
#> 26     AC Perugia Brescia Calcio     0.322        -
#> 27     SSC Napoli  Hellas Verona     0.410        -
#> 28       Parma AC  Hellas Verona     0.632        -
#> 29     AC Perugia Reggina Calcio     0.432        -
#> 30       Atalanta Reggina Calcio     0.507        -
#> 31     Lazio Roma ACF Fiorentina     0.637        -
#> 32       AC Milan ACF Fiorentina     0.613        -
#> 33     Bologna FC       Juventus     0.355        -
#> 34 Vicenza Calcio       Juventus     0.332        -
#> 35        AS Bari          Inter     0.370        -
#> 36       Parma AC          Inter     0.608        -
#> 
#> $round_plot
```
...
#>     biv_pois 0.252    0.342 0.711    0.313 0.350
#>  double_pois 0.254    0.379 0.711    0.310 0.363
#> 
#> Confusion Matrices
#> Model: biv_pois 
#> 
