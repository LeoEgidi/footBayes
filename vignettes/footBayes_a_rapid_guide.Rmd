...
#> 1 logStrength[1, AC Milan]  2.20   2.17  0.951 0.916  0.632 3.82   1.00     528.     927.
#> 2 logStrength[2, AC Milan]  1.45   1.43  1.10  1.12  -0.381 3.22   1.00     268.     439.
#> 3 logStrength[3, AC Milan]  2.47   2.47  1.27  1.32   0.495 4.59   1.01     140.     329.
#> 4 logStrength[4, AC Milan]  2.97   2.92  1.43  1.49   0.726 5.37   1.01     147.     365.
#> 5 logStrength[1, AS Roma]   1.51   1.50  0.94  0.964 -0.001 3.01   1.00     495.     757.
#> 6 logStrength[2, AS Roma]   0.046  0.055 1.06  1.09  -1.66  1.82   1.00     255.     518.
#> 7 logStrength[3, AS Roma]   0.943  0.936 1.22  1.25  -1.08  2.99   1.01     147.     244.
#> 8 logStrength[4, AS Roma]   1.16   1.17  1.36  1.37  -1.07  3.41   1.00     128.     192.
#> 9 logTie                   -0.007 -0.006 0.083 0.084 -0.147 0.129  1.00    1831.    1617.
```
...
#> 11       1           Inter        2.2320
#> 7        1        AC Milan        1.7867
#> 13       1      SSC Napoli        1.4410
#> 6        1        Juventus        1.2856
#> 20       1        Atalanta        0.9298
#> 19       1      Lazio Roma        0.6326
#> 15       1         AS Roma        0.5213
#> 5        1 Sassuolo Calcio        0.3334
#> 2        1   Hellas Verona       -0.0814
#> 1        1  ACF Fiorentina       -0.1084
#> 
#> Posterior summaries for model parameters:
#> # A tibble: 3 × 10
#>   variable                mean median    sd   mad     q5   q95  rhat ess_bulk ess_tail
#>   <chr>                  <dbl>  <dbl> <dbl> <dbl>  <dbl> <dbl> <dbl>    <dbl>    <dbl>
#> 1 logStrength[AC Milan]  1.84   1.83  0.718 0.692  0.661 3.10   1.02     94.9     225.
#> 2 logStrength[AS Roma]   0.662  0.633 0.704 0.693 -0.461 1.87   1.02     90.3     240.
#> 3 logTie                -0.118 -0.117 0.086 0.088 -0.256 0.022  1       820.     1128.
```
...
#>   variable  mean median    sd   mad     q5   q95  rhat ess_bulk ess_tail
#>   <chr>    <dbl>  <dbl> <dbl> <dbl>  <dbl> <dbl> <dbl>    <dbl>    <dbl>
#> 1 logTie   0.021  0.024 0.091 0.089 -0.126 0.171  1.00    2619.    1301.
#> 2 home     0.232  0.233 0.111 0.108  0.058 0.414  1.00    2461.    1439.
```
...
#> 11       1           Inter          3.45
#> 7        1        AC Milan          2.96
#> 13       1      SSC Napoli          2.57
#> 6        1        Juventus          2.49
#> 20       1        Atalanta          2.24
#> 19       1      Lazio Roma          2.04
#> 15       1         AS Roma          1.79
#> 5        1 Sassuolo Calcio          1.48
#> 1        1  ACF Fiorentina          1.11
#> 2        1   Hellas Verona          1.06
#> 
#> Posterior summaries for model parameters:
#> # A tibble: 2 × 10
#>   variable   mean median    sd   mad     q5   q95  rhat ess_bulk ess_tail
#>   <chr>     <dbl>  <dbl> <dbl> <dbl>  <dbl> <dbl> <dbl>    <dbl>    <dbl>
#> 1 logTie   -0.123 -0.124 0.087 0.092 -0.259 0.021  1.00     534.     835.
#> 2 home      0.204  0.204 0.097 0.098  0.047 0.363  1.00     422.     624.
```
...
<img src="plot_btdPosterior_dyn-1.png" alt="plot of chunk plot_btdPosterior_dyn" width="700px" />
...
<div class="figure" style="text-align: center">
<img src="plot_btdPosterior_stat-1.png" alt="plot of chunk plot_btdPosterior_stat" width="700px" />
...
<div class="figure" style="text-align: center">
<img src="plot_btdPosterior_teams_dyn-1.png" alt="plot of chunk plot_btdPosterior_teams_dyn" width="700px" />
...
<div class="figure" style="text-align: center">
<img src="plot_btdPosterior_teams_stat-1.png" alt="plot of chunk plot_btdPosterior_teams_stat" width="700px" />
...
<div class="figure" style="text-align: center">
<img src="plot_btdPosterior_teams_dyn_dens-1.png" alt="plot of chunk plot_btdPosterior_teams_dyn_dens" width="700px" />
...
<div class="figure" style="text-align: center">
<img src="plot_btdPosterior_teams_stat_dens-1.png" alt="plot of chunk plot_btdPosterior_teams_stat_dens" width="700px" />
...
<div class="figure" style="text-align: center">
<img src="plot_logStrength_teams_dyn-1.png" alt="plot of chunk plot_logStrength_teams_dyn" width="700px" />
...
- The Bayesian approach: the ```stan_foot``` function produces posterior sampling by using the underlying ```cmdstan``` ecosystem. The user can choose the number of iterations (```iter_sampling```), the number of Markov chains (```chains```), and other optional arguments values. The output is an object of class ```stanFoot```.
...
#>   variable        mean median    sd   mad     q5    q95  rhat ess_bulk ess_tail
#>   <chr>          <dbl>  <dbl> <dbl> <dbl>  <dbl>  <dbl> <dbl>    <dbl>    <dbl>
#> 1 home           0.287  0.291 0.07  0.067  0.173  0.395  1.00     777.     565.
#> 2 rho           -1.79  -1.75  0.366 0.313 -2.43  -1.29   1.00     615.     363.
#> 3 sigma_att      0.213  0.204 0.066 0.064  0.118  0.337  1.01     232.     334.
#> 4 sigma_def      0.223  0.216 0.071 0.064  0.12   0.352  1.00     391.     302.
#> 5 att[AS Roma]   0.272  0.272 0.129 0.132  0.064  0.486  1.00     710.     642.
#> 6 att[AC Milan]  0.135  0.133 0.128 0.125 -0.083  0.345  1.01     952.     581.
#> 7 def[AS Roma]  -0.205 -0.185 0.157 0.152 -0.463  0.034  1.01     965.     558.
#> 8 def[AC Milan]  0.001  0.007 0.123 0.123 -0.203  0.201  1.01    1105.     540.
```
...
<div class="figure" style="text-align: center">
<img src="static_fit_corr-1.png" alt="plot of chunk static_fit_corr" width="700px" />
...
<div class="figure" style="text-align: center">
<img src="comparing_priors-1.png" alt="plot of chunk comparing_priors" width="700px" />
...
#>   variable    mean median    sd   mad     q5    q95  rhat ess_bulk ess_tail
#>   <chr>      <dbl>  <dbl> <dbl> <dbl>  <dbl>  <dbl> <dbl>    <dbl>    <dbl>
#> 1 home       0.279  0.28  0.069 0.069  0.162  0.385  1.00   378.      405. 
#> 2 rho       -1.77  -1.73  0.35  0.327 -2.42  -1.25   1.00   325.      246. 
#> 3 sigma_att  0.045  0.047 0.01  0.009  0.023  0.059  1.62     3.43     12.1
#> 4 sigma_def  0.054  0.055 0.01  0.012  0.038  0.072  1.66     3.38     12.8
```
...
#>   variable   mean median    sd   mad    q5   q95  rhat ess_bulk ess_tail
#>   <chr>     <dbl>  <dbl> <dbl> <dbl> <dbl> <dbl> <dbl>    <dbl>    <dbl>
#> 1 home      0.409  0.409 0.046 0.048 0.337 0.481  1      489.      245. 
#> 2 sigma_att 0.047  0.051 0.013 0.013 0.025 0.065  1.66     3.34     41.0
#> 3 sigma_def 0.051  0.05  0.01  0.01  0.036 0.07   1.34     5.37     21.5
```
...
#>   variable   mean median    sd   mad    q5   q95  rhat ess_bulk ess_tail
#>   <chr>     <dbl>  <dbl> <dbl> <dbl> <dbl> <dbl> <dbl>    <dbl>    <dbl>
#> 1 home      0.41   0.409 0.047 0.051 0.339 0.494  1.04   122.      258. 
#> 2 sigma_att 0.03   0.029 0.007 0.006 0.019 0.044  1.46     4.04     26.6
#> 3 sigma_def 0.049  0.049 0.013 0.014 0.032 0.072  1.56     3.88     17.8
```
...
#>   variable    mean median    sd   mad     q5    q95  rhat ess_bulk ess_tail
#>   <chr>      <dbl>  <dbl> <dbl> <dbl>  <dbl>  <dbl> <dbl>    <dbl>    <dbl>
#> 1 home       0.158  0.16  0.068 0.065  0.043  0.265  1      2026.    1410. 
#> 2 rho       -1.09  -1.09  0.161 0.162 -1.36  -0.844  1.00   1496.    1283. 
#> 3 sigma_att  0.035  0.032 0.022 0.02   0.008  0.07   1.07     24.9     34.6
#> 4 sigma_def  0.034  0.031 0.024 0.025  0.005  0.078  1.08     17.6     54.5
```
...
<div class="figure" style="text-align: center">
<img src="abilities-1.png" alt="plot of chunk abilities" width="700px" /><img src="abilities-2.png" alt="plot of chunk abilities" width="700px" />
...
<div class="figure" style="text-align: center">
<img src="abilities_dyn-1.png" alt="plot of chunk abilities_dyn" width="700px" />
...
<div class="figure" style="text-align: center">
<img src="pp_foot-1.png" alt="plot of chunk pp_foot" width="700px" />
...
<div class="figure" style="text-align: center">
<img src="pp_foot-2.png" alt="plot of chunk pp_foot" width="700px" />
<p class="caption">plot of chunk pp_foot</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="pp_checks-1.png" alt="plot of chunk pp_checks" width="700px" />
...
#> 1 Reggina Calcio  AC Milan  0.371  0.258  0.371 1-1 (0.111)
#> 
#> $prob_plot
```
...
<div class="figure" style="text-align: center">
<img src="foot_prob_weekly_predict-1.png" alt="plot of chunk foot_prob_weekly_predict" width="700px" />
...
#> 1   Hellas Verona     Bologna FC     0.340        -
#> 2           Inter     Bologna FC     0.470        -
#> 3  Udinese Calcio     SSC Napoli     0.482        -
#> 4  ACF Fiorentina     SSC Napoli     0.540        -
#> 5        US Lecce     Lazio Roma     0.230        -
#> 6           Inter     Lazio Roma     0.350        -
#> 7  Brescia Calcio        AS Bari     0.635        -
#> 8  Reggina Calcio        AS Bari     0.610        -
#> 9  Udinese Calcio Vicenza Calcio     0.378        -
#> 10 Brescia Calcio Vicenza Calcio     0.532        -
#> 11        AS Roma       Parma AC     0.395        -
#> 12       US Lecce       Parma AC     0.270        -
#> 13        AS Roma       AC Milan     0.478        -
#> 14 Reggina Calcio       AC Milan     0.392        -
#> 15  Hellas Verona     AC Perugia     0.390        -
#> 16       Juventus     AC Perugia     0.623        -
#> 17 ACF Fiorentina       Atalanta     0.465        -
#> 18       Juventus       Atalanta     0.537        -
#> 19     SSC Napoli        AS Roma     0.238        -
#> 20        AS Bari        AS Roma     0.240        -
#> 21     Lazio Roma Udinese Calcio     0.710        -
#> 22       Atalanta Udinese Calcio     0.555        -
#> 23     Bologna FC       US Lecce     0.520        -
#> 24 Vicenza Calcio       US Lecce     0.550        -
#> 25       AC Milan Brescia Calcio     0.517        -
#> 26     AC Perugia Brescia Calcio     0.405        -
#> 27     SSC Napoli  Hellas Verona     0.420        -
#> 28       Parma AC  Hellas Verona     0.632        -
#> 29     AC Perugia Reggina Calcio     0.522        -
#> 30       Atalanta Reggina Calcio     0.470        -
#> 31     Lazio Roma ACF Fiorentina     0.632        -
#> 32       AC Milan ACF Fiorentina     0.600        -
#> 33     Bologna FC       Juventus     0.310        -
#> 34 Vicenza Calcio       Juventus     0.312        -
#> 35        AS Bari          Inter     0.308        -
#> 36       Parma AC          Inter     0.588        -
#> 
#> $round_plot
```

<div class="figure" style="text-align: center">
<img src="foot_roundrobin-1.png" alt="plot of chunk foot_roundrobin" width="700px" />
...
<div class="figure" style="text-align: center">
<img src="rank_pred1-1.png" alt="plot of chunk rank_pred1" width="700px" />
...
<div class="figure" style="text-align: center">
<img src="rank_pred1-2.png" alt="plot of chunk rank_pred1" width="700px" />
<p class="caption">plot of chunk rank_pred1</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="rank_pred2-1.png" alt="plot of chunk rank_pred2" width="700px" />
...
<div class="figure" style="text-align: center">
<img src="rank_pred2-2.png" alt="plot of chunk rank_pred2" width="700px" />
<p class="caption">plot of chunk rank_pred2</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="rank_pred2-3.png" alt="plot of chunk rank_pred2" width="700px" />
<p class="caption">plot of chunk rank_pred2</p>
</div>
...
#>     biv_pois 0.253    0.347 0.713    0.313 0.350
#>  double_pois 0.257    0.374 0.719    0.306 0.360
#> 
#> Confusion Matrices
#> Model: biv_pois 
#> 
