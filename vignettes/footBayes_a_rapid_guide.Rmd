...
#> 1 logStrength[1, A…  2.05   2.05  0.939 0.935  0.524 3.65   1.01    119.     507. 
#> 2 logStrength[2, A…  1.19   1.13  1.06  1.05  -0.511 2.98   1.05     54.7    130. 
#> 3 logStrength[3, A…  2.19   2.12  1.28  1.21   0.126 4.42   1.08     22.7     72.2
#> 4 logStrength[4, A…  2.68   2.62  1.50  1.46   0.273 5.31   1.07     26.8     83.9
#> 5 logStrength[1, A…  1.35   1.32  0.872 0.856 -0.099 2.79   1.01    126.     330. 
#> 6 logStrength[2, A… -0.2   -0.228 1.03  1.06  -1.86  1.51   1.05     51.5    118. 
#> 7 logStrength[3, A…  0.694  0.673 1.24  1.21  -1.26  2.77   1.08     26.5     60.0
#> 8 logStrength[4, A…  0.89   0.813 1.42  1.35  -1.34  3.24   1.08     20.5     72.3
#> 9 logTie            -0.01  -0.01  0.088 0.087 -0.149 0.137  1.00   1113.    1118.
```
...
#> 11       1           Inter         2.433
#> 7        1        AC Milan         2.149
#> 13       1      SSC Napoli         1.605
#> 6        1        Juventus         1.546
#> 20       1        Atalanta         1.045
#> 19       1      Lazio Roma         1.022
#> 15       1         AS Roma         0.997
#> 5        1 Sassuolo Calcio         0.602
#> 1        1  ACF Fiorentina         0.276
#> 2        1   Hellas Verona         0.198
#> 
#> Posterior summaries for model parameters:
#> # A tibble: 3 × 10
#>   variable            mean median    sd   mad     q5   q95  rhat ess_bulk ess_tail
#>   <chr>              <dbl>  <dbl> <dbl> <dbl>  <dbl> <dbl> <dbl>    <dbl>    <dbl>
#> 1 logStrength[AC M…  1.95   2.01  0.709 0.703  0.688  3.07  1.00     99.1     139.
#> 2 logStrength[AS R…  0.766  0.809 0.694 0.693 -0.465  1.81  1.00     93.2     171.
#> 3 logTie            -0.117 -0.116 0.084 0.083 -0.256  0.02  1.00    952.     1120.
```
...
#>   variable  mean median    sd   mad     q5   q95  rhat ess_bulk ess_tail
#>   <chr>    <dbl>  <dbl> <dbl> <dbl>  <dbl> <dbl> <dbl>    <dbl>    <dbl>
#> 1 logTie   0.025  0.027 0.091 0.09  -0.125 0.176  1       2180.    1259.
#> 2 home     0.229  0.229 0.11  0.113  0.044 0.408  1.00    2445.    1329.
```
...
#> 11       1           Inter          5.16
#> 7        1        AC Milan          4.88
#> 13       1      SSC Napoli          4.32
#> 6        1        Juventus          4.24
#> 20       1        Atalanta          3.90
#> 19       1      Lazio Roma          3.75
#> 15       1         AS Roma          3.53
#> 5        1 Sassuolo Calcio          3.16
#> 1        1  ACF Fiorentina          2.85
#> 2        1   Hellas Verona          2.75
#> 
#> Posterior summaries for model parameters:
#> # A tibble: 2 × 10
#>   variable   mean median    sd   mad     q5   q95  rhat ess_bulk ess_tail
#>   <chr>     <dbl>  <dbl> <dbl> <dbl>  <dbl> <dbl> <dbl>    <dbl>    <dbl>
#> 1 logTie   -0.112 -0.111 0.086 0.086 -0.252 0.03   1.00     513.     650.
#> 2 home      0.206  0.204 0.096 0.099  0.044 0.364  1.00     481.     603.
```
...
#>   variable        mean median    sd   mad     q5    q95  rhat ess_bulk ess_tail
#>   <chr>          <dbl>  <dbl> <dbl> <dbl>  <dbl>  <dbl> <dbl>    <dbl>    <dbl>
#> 1 home           0.283  0.283 0.069 0.068  0.172  0.395  1.01     904.     440.
#> 2 rho           -1.77  -1.72  0.336 0.323 -2.40  -1.31   1.00     930.     634.
#> 3 sigma_att      0.214  0.208 0.066 0.061  0.121  0.33   1.01     278.     323.
#> 4 sigma_def      0.229  0.221 0.068 0.06   0.128  0.351  1.00     333.     341.
#> 5 att[AS Roma]   0.277  0.276 0.128 0.139  0.075  0.484  1.01     685.     485.
#> 6 att[AC Milan]  0.138  0.134 0.123 0.116 -0.063  0.348  1.00    1277.     624.
#> 7 def[AS Roma]  -0.207 -0.2   0.138 0.136 -0.445  0.003  1.00     918.     552.
#> 8 def[AC Milan]  0.005  0.011 0.129 0.131 -0.202  0.211  1.00     912.     579.
```
...
#>   variable    mean median    sd   mad     q5    q95  rhat ess_bulk ess_tail
#>   <chr>      <dbl>  <dbl> <dbl> <dbl>  <dbl>  <dbl> <dbl>    <dbl>    <dbl>
#> 1 home       0.279  0.278 0.071 0.069  0.155  0.387  1.01   336.      270. 
#> 2 rho       -1.74  -1.71  0.34  0.321 -2.41  -1.26   1.02   384.      282. 
#> 3 sigma_att  0.045  0.043 0.013 0.012  0.029  0.074  1.89     2.92     18.2
#> 4 sigma_def  0.059  0.056 0.017 0.015  0.036  0.091  2.05     2.75     29.7
```
...
#>   variable   mean median    sd   mad    q5   q95  rhat ess_bulk ess_tail
#>   <chr>     <dbl>  <dbl> <dbl> <dbl> <dbl> <dbl> <dbl>    <dbl>    <dbl>
#> 1 home      0.414  0.415 0.046 0.046 0.335 0.491  1.03    84.9     277. 
#> 2 sigma_att 0.029  0.029 0.011 0.013 0.014 0.049  2.43     2.55     18.7
#> 3 sigma_def 0.057  0.057 0.014 0.014 0.035 0.08   1.66     3.39     15.1
```
...
#>   variable   mean median    sd   mad    q5   q95  rhat ess_bulk ess_tail
#>   <chr>     <dbl>  <dbl> <dbl> <dbl> <dbl> <dbl> <dbl>    <dbl>    <dbl>
#> 1 home      0.396  0.396 0.053 0.051 0.317 0.487  1.00   434.      220. 
#> 2 sigma_att 0.049  0.05  0.014 0.018 0.027 0.07   1.68     3.24     17.5
#> 3 sigma_def 0.051  0.048 0.013 0.01  0.036 0.076  1.34     5.15     44.7
```
...
#>   variable    mean median    sd   mad     q5    q95  rhat ess_bulk ess_tail
#>   <chr>      <dbl>  <dbl> <dbl> <dbl>  <dbl>  <dbl> <dbl>    <dbl>    <dbl>
#> 1 home       0.159  0.159 0.067 0.069  0.05   0.267  1.00   1138.    1377. 
#> 2 rho       -1.10  -1.10  0.163 0.154 -1.39  -0.853  1.00    914.     516. 
#> 3 sigma_att  0.039  0.034 0.021 0.021  0.014  0.079  1.02     25.4     81.6
#> 4 sigma_def  0.032  0.027 0.019 0.017  0.01   0.07   1.09     20.5     84.3
```
...
#> 1 Reggina Calcio  AC Milan  0.351  0.245  0.405 0-0 (0.088)
#> 
#> $prob_plot
```
...
#>    <chr>          <chr>          <chr>     <chr>   
#>  1 Hellas Verona  Bologna FC     0.352     -       
#>  2 Inter          Bologna FC     0.435     -       
#>  3 Udinese Calcio SSC Napoli     0.505     -       
#>  4 ACF Fiorentina SSC Napoli     0.52      -       
#>  5 US Lecce       Lazio Roma     0.27      -       
#>  6 Inter          Lazio Roma     0.322     -       
#>  7 Brescia Calcio AS Bari        0.62      -       
#>  8 Reggina Calcio AS Bari        0.57      -       
#>  9 Udinese Calcio Vicenza Calcio 0.418     -       
#> 10 Brescia Calcio Vicenza Calcio 0.527     -       
#> # ℹ 26 more rows
#> 
#> $round_plot
```
...
#>     biv_pois 0.253    0.347 0.713    0.312 0.348
#>  double_pois 0.256    0.379 0.718    0.306 0.359
#> 
#> Confusion Matrices
#> Model: biv_pois 
#> 
