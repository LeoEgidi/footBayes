...
transformed parameters{
      ...
      vector<lower=0>[ind_comm_prior ? ntimes : 0] comm_sd_att = inv_sqrt(comm_prec_att);   // SD for commensurate prior
      vector<lower=0>[ind_comm_prior ? ntimes : 0] comm_sd_def = inv_sqrt(comm_prec_def);   // SD for commensurate prior
